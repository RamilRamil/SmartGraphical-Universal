"""Multi-file bundle graph assembly for Solidity / C / Rust.

Relocated verbatim from ``web_api.py`` (feature 016). Owns provider/consumer
resolution and import/inheritance/include/module edge construction plus bundle
graph consolidation and revalidation. Depends only on serializers + adapters;
never imports ``web_api``.
"""
import hashlib
import json
import os
...
from smartgraphical.services.serializers import _validate_and_normalize_payload
